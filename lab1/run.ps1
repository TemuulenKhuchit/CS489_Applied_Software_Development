...
# Using 'edu' as the project source root (no 'src' folder)
$srcRoot = Join-Path $PSScriptRoot 'edu'

$productFile = Join-Path $srcRoot 'miu/cs/cs489appsd/lab1/productmgmtapp/model/Product.java'
$appFile = Join-Path $srcRoot 'miu/cs/cs489appsd/lab1a/productmgmtapp/ProductMgmtApp.java'
...
Write-Host "Running..."
& java -cp $outDir edu.miu.cs.cs489appsd.lab1a.productmgmtapp.ProductMgmtApp